namespace Practice1
{
    class PoliceCar : LicensedVehicle
    {
        ...
        public void UseRadar(LicensedVehicle vehicle)
        {
        ...
        public void ActivateStationAlarm(LicensedVehicle infractor)
        {
            if (policeStation != null)
            {
                policeStation.TriggerAlarm();
                infractorPlate = infractor.GetLicensePlate();
                policeStation.DispatchAlarm(infractor, this);
            }
